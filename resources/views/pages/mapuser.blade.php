    ...
    <script>
        ...
        legend.onAdd = function (map) {
            ...
            div.innerHTML = `
                ...
                <b>Daerah Potensial: <span id="potensial-count"></span></b><br>
                <b>Daerah Tidak Potensial: <span id="tidak-potensial-count"></span></b>
            `;
            return div;
        };
        ...
        fetch('/map/data')
            ...
            .then(data => {
                ...
                var tidakPotensialCount = data.filter(location => location.status === 'tidak potensial').length;
                ...
                document.getElementById('tidak-potensial-count').textContent = tidakPotensialCount; // Set tidak potensial locations
